...
if($name == "Admin") { header('Location: admin.php'); die; }
...
<link rel="stylesheet" type="text/css" href="nav.css">
  ...
  <div class="container">
   <div class="container">
    <div class="row">
        <div class="col-md-4">
            <img style="float:left;width:290px;height:400px; margin-right:20px;margin-top: auto;margin-left: auto;margin-bottom: 20px" class="img-rounded" src="img/3dp.jpg" />
    ...
    $(document).ready(function() { 
        $('.cancelbooking').on('click', function() {
          var date = $(this).attr('data-booking');
          var seat = $(this).attr('data-seat');

          var result = confirm("Are you sure you want to cancel your reservation?");
          if(result) {

            $.post('cancel.php', {'ctime': date, 'cseat': seat}, function(data) {
